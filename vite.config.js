  ...
  plugins: [
    UnoCSS({
      shortcuts:[ 
        ...
        {s2:'w-[15vw] h-[15vw] text-[13vw] bg-gray-200 p-1 justify-center items-center rd-2'},
        {s4:'w-[10vw] h-[10vw] text-[8vw] bg-gray-200 p-1 justify-center items-center rd-2'},
        {sSmall:'w-[8vw] h-[8vw] text-[6vw] bg-gray-200 p-1 justify-center items-center rd-2'}
      ],
